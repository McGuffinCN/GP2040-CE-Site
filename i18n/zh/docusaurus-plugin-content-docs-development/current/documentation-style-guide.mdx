...
要使用热键组合，您需要在 [Frontmatter](#frontmatter) 下方但在 [Introduction](#introduction) 上方导入两个组件：
...
要使用选项卡，您需要在 [Frontmatter](#frontmatter) 下方但在 [Introduction](#introduction) 上方导入两个特殊方法：
